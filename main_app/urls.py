...
urlpatterns = [
   ...
   path('artists/<int:pk>/experiences/<int:experience_id>/create/', views.ExperienceCreate.as_view(), name='experience_create'),
   path('artists/<int:pk>/experiences/<int:experience_id>/update/', views.ExperienceUpdate.as_view(), name='experience_update'),
   path('artists/<int:pk>/experiences/<int:experience_id>/delete/', views.ExperienceDelete.as_view(), name='experience_delete'),
